...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/kate-22.08.0.tar.xz
...
%prep
%setup -q -n kate-22.08.0
cd %{_builddir}/kate-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661547680
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libkateprivate.so.22.08.0
