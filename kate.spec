...
Version  : 24.08.2
Release  : 77
URL      : https://download.kde.org/stable/release-service/24.08.2/src/kate-24.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.08.2/src/kate-24.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.2/src/kate-24.08.2.tar.xz.sig
...
%setup -q -n kate-24.08.2
cd %{_builddir}/kate-24.08.2
pushd ..
cp -a kate-24.08.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728605570
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkateprivate.so.24.08.2
...
/usr/lib64/libkateprivate.so.24.08.2
