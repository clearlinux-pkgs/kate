...
Source0  : https://download.kde.org/stable/release-service/22.08.2/src/kate-22.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.2/src/kate-22.08.2.tar.xz.sig
...
%prep
%setup -q -n kate-22.08.2
cd %{_builddir}/kate-22.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665719486
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libkateprivate.so.22.08.2
