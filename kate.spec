...
Version  : 25.04.2
Release  : 85
URL      : https://download.kde.org/stable/release-service/25.04.2/src/kate-25.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.2/src/kate-25.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.2/src/kate-25.04.2.tar.xz.sig
...
%setup -q -n kate-25.04.2
cd %{_builddir}/kate-25.04.2
pushd ..
cp -a kate-25.04.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749510708
mkdir -p clr-build
pushd clr-build
...
/usr/share/doc/HTML/en/kate/media-playback-start-22.png
...
/usr/share/doc/HTML/en/kate/run-build-22.png
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkateprivate.so.25.04.2
...
/V3/usr/lib64/qt6/plugins/kf6/ktexteditor/templateplugin.so
/V3/usr/lib64/qt6/plugins/kf6/ktexteditor/textfilterplugin.so
/usr/lib64/libkateprivate.so.25.04.2
...
/usr/lib64/qt6/plugins/kf6/ktexteditor/templateplugin.so
...
%files locales -f kate.lang -f katetextfilter.lang -f katexmltools.lang -f formatplugin.lang -f kate-ctags-plugin.lang -f kate-replicode-plugin.lang -f katebacktracebrowserplugin.lang -f katebuild-plugin.lang -f katecloseexceptplugin.lang -f katecolorpickerplugin.lang -f katecompilerexplorer.lang -f kateexternaltoolsplugin.lang -f katefilebrowserplugin.lang -f katefiletree.lang -f kategdbplugin.lang -f kategitblameplugin.lang -f katekeyboardmacros.lang -f katekonsoleplugin.lang -f kateproject.lang -f katesearch.lang -f katesnippetsplugin.lang -f katesql.lang -f katesymbolviewer.lang -f katexmlcheck.lang -f ktexteditorpreviewplugin.lang -f lspclient.lang -f rainbowparens.lang -f rbqlplugin.lang -f tabswitcherplugin.lang
%defattr(-,root,root,-)
